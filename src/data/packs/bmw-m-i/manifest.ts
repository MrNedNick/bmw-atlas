...
export const bmwMIInventory: MIInventoryItem[] = [
  ...
  },
  {
    ...
    family: "X3 M",
    generation: "F97",
    generationId: "bmw-x3-m-f97",
    status: "detailed",
    sourceIds: ["bmw-x3-m-f97-launch"],
    imagePhase: "launch",
    missingFields: ["рестайлинг 2021", "производство и оценки безопасности"],
  },
  {
    id: "bmw-m-i-ix2-u10",
    lineage: "i",
    family: "iX2",
    generation: "U10",
    generationId: "bmw-ix2-u10",
    status: "detailed",
    sourceIds: ["bmw-x2-u10-launch"],
    imagePhase: "launch",
    missingFields: ["eDrive20 по рынкам", "оценки безопасности"],
  },
  {
    id: "bmw-m-i-ix1-u11",
    lineage: "i",
    family: "iX1",
    generation: "U11",
    generationId: "bmw-ix1-u11",
    status: "detailed",
    sourceIds: ["bmw-x1-u11-launch"],
    imagePhase: "launch",
    missingFields: ["eDrive20/eDrive25 по рынкам", "оценки безопасности"],
  },
  {
    id: "bmw-m-i-m1-e26",
    lineage: "M",
