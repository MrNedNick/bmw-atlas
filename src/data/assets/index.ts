...
const m3E30Reference: PhotoReference = {
  publisher: "BMW M",
  page: "https://www.bmw-m.com/en/topics/magazine-article-pool/bmw-m3-generationen.html",
  imageUrl:
    "https://www.bmw-m.com/content/dam/bmw/marketBMW_M/www_bmw-m_com/topics/magazine-article-pool/2024/m3-generationen/bmw-m3-e30-sport-evolution-hd-04.jpg?imwidth=1600",
  localFile: "references/images/bmw-m3-e30-sport-evolution-hd-04.jpg",
  imageId: "bmw-m3-e30-sport-evolution-hd-04",
  phase: "historical",
  verifiedDetails: [
    "двухдверный BMW M3 Sport Evolution E30",
    "четыре круглые фары и узкая двойная решётка с эмблемой M3",
    "угловатые расширенные колёсные арки и короткие свесы E30",
    "чёрный передний спойлер и красная декоративная полоса бампера",
    "двухдверный кузов с тонкими стойками и прямой линией крыши",
    "периодные многоспицевые колёса и наружные зеркала E30",
  ],
};
const m3E36Reference: PhotoReference = {
  publisher: "BMW M",
  page: "https://www.bmw-m.com/en/topics/magazine-article-pool/bmw-m3-generationen.html",
  imageUrl:
    "https://www.bmw-m.com/content/dam/bmw/marketBMW_M/www_bmw-m_com/topics/magazine-article-pool/2024/m3-generationen/bmw-m3-e36-limousine-hd-04.jpg?imwidth=1600",
  localFile: "references/images/bmw-m3-e36-limousine-hd-04.jpg",
  imageId: "bmw-m3-e36-limousine-hd-04",
  phase: "historical",
  verifiedDetails: [
    "четырёхдверный BMW M3 Sedan E36",
    "узкая двойная решётка и прямоугольные фары с двойными модулями",
    "M-передний бампер с широким центральным воздухозаборником",
    "прямоугольные противотуманные фары и чёрные боковые молдинги",
    "синие боковые юбки, компактная линия крыши и четыре двери",
...
const photoByGeneration: Record<string, PhotoMetadata> = {
  ...
  "bmw-x6-g06": editorialPhoto(
    ...
    "https://www.press.bmwgroup.com/global/photo/detail/P90356696/The-new-BMW-X6-Stills-07-2019",
    "BMW X6 · G06, 2019",
    {
      publisher: "BMW Group PressClub",
      page: "https://www.press.bmwgroup.com/global/photo/detail/P90356696/The-new-BMW-X6-Stills-07-2019",
      imageUrl:
        "https://mediapool.bmwgroup.com/download/edown/pressclub/publicq?actEvent=image&attachment=1&dokNo=P90356696",
      localFile: "references/images/P90356696-bmw-x6-g06.jpg",
      imageId: "P90356696",
      phase: "launch",
      verifiedDetails: [
        "дорестайлинговый BMW X6 G06 в бронзовом цвете, передний ракурс три четверти",
        "покатая линия крыши, пятидверный кузов и короткий задний свес",
        "широкие ранние фары с двумя многоугольными модулями и синими акцентами",
        "двойная решётка с вертикальными светлыми планками",
        "чёрные нижние воздухозаборники и отдельные горизонтальные секции над боковыми нишами",
        "серебристые разветвлённые спицы дисков, синие тормозные суппорты и номер M VJ 5283",
      ],
    },
  ),
  ...
  "bmw-x7-g07": editorialPhoto(
    ...
    "https://www.press.bmwgroup.com/global/photo/detail/P90326033/the-first-ever-bmw-x7-10/2018?language=en",
    "BMW X7 · G07, 2018",
    {
      publisher: "BMW Group PressClub",
      page: "https://www.press.bmwgroup.com/global/photo/detail/P90326033/the-first-ever-bmw-x7-10/2018?language=en",
      imageUrl:
        "https://mediapool.bmwgroup.com/download/edown/pressclub/publicq?actEvent=image&attachment=1&dokNo=P90326033",
      localFile: "references/images/P90326033-bmw-x7-g07.jpg",
      imageId: "P90326033",
      phase: "launch",
      verifiedDetails: [
        ...
        "передний ракурс три четверти неподвижной машины; многоспицевые диски 757 и номер M XX 7018",
      ],
    },
  ),
