...
- Истории 1 Series, 3 Series, 5 Series, 7 Series, четырёх поколений X3, пяти поколений X5, BMW M1, шести поколений M3, семи поколений M5 и общий обзор Isetta: 51 поколение и обзорная ветвь.
- Отдельное изображение для каждой из 51 ветви, включая все поколения 1 Series, 7 Series и X3, новый i3 NA0, X5 G65 и все внесённые M3/M5. Галерея «Фото» открывает нужное поколение.
